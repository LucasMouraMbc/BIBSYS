    ...
    <div class="offset-md-1 col-md-10">
      ...
      <table class="table">
        ...
        <tbody>
          ...
          $sql = "SELECT *, e.id as idEmprestimo, u.id as idUsuario, l.id as idLivro from emprestimos as e JOIN usuarios as u on u.id = e.idUsuario join livros as l on l.id = e.idLivro ORDER BY idEmprestimo DESC";
          ...
          foreach ($result as $r) {
            ...
            if ($devolvido == 'n') {
              ...
              $btn =
                "<button class='btn btn-success btn-sm btn-extra-pequeno' disabled>Devolvido</button>";
            }
            echo "
      <tr>
        <th scope='row'>$id</th>
