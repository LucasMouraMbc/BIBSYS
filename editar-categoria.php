  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="listar-categorias.php">Categorias</a></li>
    ...
    <div class="card mb-3">
      ...
      <div class="card-body">
        ...
        <div class="pt-4 pb-2">
          <h5 class="card-title text-center pb-0 fs-4">Editar categoria</h5>
          <p class="text-center small">Insira os dados para alterar</p>
        </div>

        <form class="row g-3 needs-validation" novalidate method="POST" action="acoes/editar-categoria-acao.php">
          <div class="offset-md-3 col-md-6">
            <label for="yourName" class="form-label">Nome da categoria:</label>
            <input type="text" name="descricao" value="<?php echo $descricao ?>" class="form-control" id="yourName" required>
            <div class="invalid-feedback">Por favor, insira o novo nome da categoria!</div>
          </div>
