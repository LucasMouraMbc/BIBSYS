      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <form method="POST" action="acoes/editar-livro-acao.php">
              <div class="row mb-3">
                <label for="inputText" class="col-sm-2 col-form-label">Título:</label>
                <div class="col-sm-9">
                  <input type="text" value="<?php echo strtoupper($r['titulo']) ?>" name="titulo" class="form-control" required>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9">
                  <input type="text" value="<?php echo strtoupper($r['autor']) ?>" name="autor" class="form-control" required>
                  <div class="invalid-feedback">Por favor insira o autor da obra</div>
                </div>
              </div>

              <input type="hidden" name="idLivro" value="<?php echo $_GET['id'] ?>" />
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-4">
                  <input type="text" name="edicao" value="<?php echo strtoupper($r['edicao']) ?>" class="form-control" required>
                ...
                <div class="col-sm-4">
                  ...
                  <select class="form-control" name="editora" required>
                    ...
                    foreach ($result as $e) {
                      ...
                      if ($r['idEditora'] == $id) {
                        echo "<option value='$id' selected>$editora</option>";
                      } else {
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-4">
                  <input type="text" name="anoPublicacao" value="<?php echo strtoupper($r['anoPublicacao']) ?>" class="form-control" required>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-4">
                  <input type="text" name="registro" value="<?php echo strtoupper($r['registro']) ?>" class="form-control">
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-4">
                  <input type="text" name="isbn" value="<?php echo strtoupper($r['isbn']) ?>" class="form-control">
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-4">
                  <input type="date" name="dtEntrada" value="<?php echo strtoupper($r['dtEntrada']) ?>" class="form-control">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-4">
                  <input type="number" name="qtdPaginas" value="<?php echo strtoupper($r['qtdPaginas']) ?>" class="form-control" required>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-4">
                  <input type="number" name="estoque" value="<?php echo strtoupper($r['estoque']) ?>" class="form-control" required>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-4">
                  <input type="text" name="localizacao" value="<?php echo strtoupper($r['localizacao']) ?>" class="form-control">
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9">
                  <textarea class="form-control" style="height: 200px"  name="resumo"><?php echo strtoupper($r['resumo']) ?></textarea>
                </div>
              </div>
              <br>
...
<?php }else{
 echo "<script>location.href='listar-livro.php'</script>";
}?>
