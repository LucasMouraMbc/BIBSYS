...
?>
  ...
  <div class="card mb-3">
    ...
    <div class="card-body">
      ...
      <div class="pt-4 pb-2">
        <h5 class="card-title text-center pb-0 fs-4">Cadastrar nova categoria</h5>
        <?php
                  if(isset($_GET['msg'])){
                      $msg = $_GET['msg'];
                      if($msg == "sucesso"){
      ...
      <form class="row g-3 needs-validation" novalidate method="POST" action="acoes/cad-categoria.php">
